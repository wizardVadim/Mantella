...
class MantellaConfigValueDefinitionsNew:
    ...
    def get_config_values(is_integrated: bool, on_value_change_callback: Callable[..., Any] | None = None) -> ConfigValues:
        ...
        tts_category.add_config_value(TTSDefinitions.get_streamed_fast_response_config_value())
        ...
        tts_category.add_config_value(TTSDefinitions.get_openai_tts_url_config_value())
        tts_category.add_config_value(TTSDefinitions.get_openai_tts_model_config_value())
        tts_category.add_config_value(TTSDefinitions.get_openai_tts_speed_config_value())
